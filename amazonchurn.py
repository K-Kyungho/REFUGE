...
def ask_model(client, model_id: str, base_msgs: list, user_text: str, system_text: str, max_tokens=5000, temperature=0.2):
    ...
    return to_single_text_block(resp.content), resp.content 
...
def main():
    ...
    parser.add_argument("--schema_path_gt", type=str, default="rel-amazon/amazon_schema.txt")
    parser.add_argument("--stats_path", type=str, default="rel-amazon/feature_amazon.txt")
    parser.add_argument("--task_path", type=str, default="rel-amazon/task-user-churn.txt")
    parser.add_argument("--entity_table", type=str, default="customer")
    parser.add_argument("--entity_col", type=str, default="customer_id")
    ...
    def check_feature_k(
        ...
        drop_cols: tuple = ('timestamp', 'customer_name', 'customer_id'),
        sample_frac: float = 0.3,
        entity_col_local: str = "customer_id"
    ) -> dict:
        seed = random.randint(0, 10**6)
